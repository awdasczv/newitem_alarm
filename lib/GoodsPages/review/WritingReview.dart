        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  border: InputBorder.none, hintText: 'mainText'),
            ),
          ),
          Padding(
              ...
              children: [
                ...
                _success_get_image == true
                    ? Container(
                        height: 50,
                        width: 50,
                        child: Image.file(File(_uploadImage.path),
                            fit: BoxFit.cover),
                      )
                    : Container()
              ],
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(hintText: '임시 닉네임 적어두는곳'),
            ),
          ),
          Padding(
            padding: EdgeInsets.fromLTRB(10, 10, 10, 10),
              ...
              children: [
                ...
                _temp_success_get_image == true
                    ? Container(
                        height: 50,
                        width: 50,
                        child: Image.file(File(_tempUploadImage.path),
                            fit: BoxFit.cover),
                      )
                    : Container()
              ],
